...
./components/Draw.js: function Draw(f, fullscreenEnabled)
./components/EntityComponentSystem.js: function EntityComponentSystem()
./components/Fireballs.js: function Fireballs(f)
...
import { EntityComponentSystem } from './components/EntityComponentSystem.js';
import { Fireballs } from './components/Fireballs.js';
...
const EntityComponentSystemComponent = newComponentDecorator(EntityComponentSystem, reqs);
const FireballsComponent = newComponentDecorator(Fireballs, reqs);
...
EntityComponentSystemComponent as EntityComponentSystem,
enumerateFunctions,
enumerateTestFunctions,
FireballsComponent as Fireballs,
fitParentToChildren,
generateGuid,
