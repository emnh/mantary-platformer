...
async function enumerateJSFiles(directory) {
  ...
  // TODO: Make into optional dependency.
  log("import { Map as immutableMap } from 'immutable';");
  ...
  log("const reqs = { immutableMap, getComponentSystemFunctionNames: (x) => getComponentSystemFunctionNames({ immutableMap }) };");
